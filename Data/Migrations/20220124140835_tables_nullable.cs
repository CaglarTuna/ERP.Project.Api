...
{
    public partial class tables_nullable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<string>(
                name: "SpecialProductDescription",
                table: "SpeacialProductDescription",
                type: "nvarchar(1500)",
                maxLength: 1500,
                nullable: true,
            ...
            migrationBuilder.AlterColumn<string>(
                name: "ConsumptionMaterialAddress",
                table: "ConsumptionMaterialStock",
                type: "nvarchar(500)",
                maxLength: 500,
                nullable: true,
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[StandId] IS NOT NULL AND [ProcessId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[StaffId] IS NOT NULL AND [RoleId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[ProductId] IS NOT NULL AND [ProcessId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[ProductId] IS NOT NULL AND [MaterialId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[DocumentId] IS NOT NULL AND [ProductId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[MaterialId] IS NOT NULL AND [UnitsOfMeasureId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[MaterialId] IS NOT NULL AND [RawMaterialId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[LanguageId] IS NOT NULL AND [CategoriesId] IS NOT NULL");
