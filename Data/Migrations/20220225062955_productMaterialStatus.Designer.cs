...
namespace Data.Migrations
{
    ...
    [Migration("20220225062955_productMaterialStatus")]
    partial class productMaterialStatus
    {
            ...
            modelBuilder.Entity("Entity.TodoMember", b =>
                {
                    ...
                    b.HasIndex("StaffId", "TodoId")
                        .IsUnique()
                        .HasFilter("[StaffId] IS NOT NULL AND [TodoId] IS NOT NULL");
