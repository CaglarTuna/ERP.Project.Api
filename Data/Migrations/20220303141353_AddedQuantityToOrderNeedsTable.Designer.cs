...
namespace Data.Migrations
{
    ...
    [Migration("20220303141353_AddedQuantityToOrderNeedsTable")]
    partial class AddedQuantityToOrderNeedsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entity.CategoriesLanguage", b =>
                {
                    ...
                    b.HasIndex("LanguageId", "CategoriesId")
                        .IsUnique()
                        .HasFilter("[LanguageId] IS NOT NULL AND [CategoriesId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.HeightMeasure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.MaterialHeightMeasure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MaterialHeightMeasure");
                });
            ...
            modelBuilder.Entity("Entity.MaterialRawMaterials", b =>
                {
                    ...
                    b.HasIndex("MaterialId", "RawMaterialId")
                        .IsUnique()
                        .HasFilter("[MaterialId] IS NOT NULL AND [RawMaterialId] IS NOT NULL");

                    b.ToTable("MaterialRawMaterials");
                });

            modelBuilder.Entity("Entity.MaterialShape", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.MaterialSupplyRequests", b =>
                {
                    ...
                    b.HasIndex("SuplyStatuId");

                    b.ToTable("MaterialSupplyRequests");
                });

            modelBuilder.Entity("Entity.MaterialSupplyStatu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MaterialSupplyStatus");
                });
            ...
            modelBuilder.Entity("Entity.MaterialUnitsOfMeasures", b =>
                {
                    ...
                    b.HasIndex("MaterialId", "UnitsOfMeasureId")
                        .IsUnique()
                        .HasFilter("[MaterialId] IS NOT NULL AND [UnitsOfMeasureId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.OrderMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.OrderNeeds", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.OrderProducts", b =>
                {
                    ...
                    b.Property<int?>("RealizedProduction")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.Orders", b =>
                {
                    ...
                    b.Property<int?>("DellveryStaffId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.ProductDocument", b =>
                {
                    ...
                    b.HasIndex("DocumentId", "ProductId")
                        .IsUnique()
                        .HasFilter("[DocumentId] IS NOT NULL AND [ProductId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.ProductMaterials", b =>
                {
                    ...
                    b.HasIndex("ProductId", "MaterialId")
                        .IsUnique()
                        .HasFilter("[ProductId] IS NOT NULL AND [MaterialId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.ProductProcess", b =>
                {
                    ...
                    b.HasIndex("ProductId", "ProcessId")
                        .IsUnique()
                        .HasFilter("[ProductId] IS NOT NULL AND [ProcessId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.ProductStock", b =>
                {
                    ...
                    b.Property<string>("ProductStockSerialNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("ProductionProductQuantity")
                        .HasColumnType("int");

                    b.Property<int>("Status")
                        .HasColumnType("int");

                    b.Property<int>("StockProductQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entity.StaffProcessPermisions", b =>
                {
                    ...
                    b.HasIndex("StaffId", "ProcessId")
                        .IsUnique()
                        .HasFilter("[StaffId] IS NOT NULL AND [ProcessId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.StaffRoles", b =>
                {
                    ...
                    b.HasIndex("StaffId", "RoleId")
                        .IsUnique()
                        .HasFilter("[StaffId] IS NOT NULL AND [RoleId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.StandProcess", b =>
                {
                    ...
                    b.HasIndex("StandId", "ProcessId")
                        .IsUnique()
                        .HasFilter("[StandId] IS NOT NULL AND [ProcessId] IS NOT NULL");
            ...
            modelBuilder.Entity("Entity.TodoMember", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Entity.ConsumptionMaterialStock", b =>
                {
                    ...
                    b.HasOne("Entity.Orders", "Orders")
                        .WithMany("ConsumptionMaterialStocks")
            ...
            modelBuilder.Entity("Entity.MaterialHeightMeasure", b =>
                {
                    b.HasOne("Entity.HeightMeasure", "HeightMeasures")
                        .WithMany("MaterialHeightMeasures")
            ...
            modelBuilder.Entity("Entity.MaterialSupplyRequests", b =>
                {
                    ...
                    b.HasOne("Entity.MaterialSupplyStatu", "MaterialSupply")
                        .WithMany("MaterialSupplyRequests")
                        .HasForeignKey("SuplyStatuId");
            ...
            modelBuilder.Entity("Entity.Materials", b =>
                {
                    ...
                    b.HasOne("Entity.HeightMeasure", "HeightMeasure")
                        .WithMany("Materials")
                        .HasForeignKey("HeightMeasureId");

                    b.HasOne("Entity.MaterialShape", "MaterialShapes")
                        .WithMany("Materials")
                        .HasForeignKey("ShapeId");

                    b.Navigation("Currencies");

                    b.Navigation("HeightMeasure");

                    b.Navigation("MaterialShapes");
                });
            ...
            modelBuilder.Entity("Entity.OrderProducts", b =>
                {
                    ...
                    b.HasOne("Entity.Status", "Statuss")
                        .WithMany("OrderProducts")
                        .HasForeignKey("StatusId");
            ...
            modelBuilder.Entity("Entity.Orders", b =>
                {
                    ...
                    b.HasOne("Entity.Staffs", "Staff")
                        .WithMany("Orders")
                        .HasForeignKey("DellveryStaffId");
            ...
            modelBuilder.Entity("Entity.StaffProcess", b =>
                {
                    b.HasOne("Entity.OrderProducts", "Orders")
            ...
            modelBuilder.Entity("Entity.HeightMeasure", b =>
                {
                    b.Navigation("MaterialHeightMeasures");
            ...
            modelBuilder.Entity("Entity.Orders", b =>
                {
                    b.Navigation("ConsumptionMaterialStocks");
